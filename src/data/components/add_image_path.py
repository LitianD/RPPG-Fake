...
if __name__ == "__main__":
    with open("/data1/zzy/FakeNewsCode/fake-news-baselines/data/SIGIR24/Snopes/add_label_snopes_4.pkl","rb") as f:
        data_df = pkl.load(f)
    # the following code is to find the image_path of data by matching id with image_list name
    # print(data_df.columns)
    # rating = list(data_df["rating"])
    # print(rating[:5])
    # origin_path = "/data1/zzy/FakeNewsCode/fake-news-baselines/data/SIGIR24/Snopes/snopes_images"
    ...
    print(len(data_df))
    with open("/data1/zzy/FakeNewsCode/fake-news-baselines/data/SIGIR24/Snopes/add_label_snopes_4.pkl","wb") as f:
        pkl.dump(data_df,f)